...
public:
	...
	class CPlugin
	{
		...
		CPlugin(int i, const char* p, const char* n, char* e, int d , const char * shortName );
		~CPlugin();
...
public:
	...
	CPlugin* loadPlugin(const char* path, const char* name, char* error, int debug , const char * shortName );
	void unloadPlugin(CPlugin** a);
	int loadPluginsFromDir(const char* dir, bool debug = false );
